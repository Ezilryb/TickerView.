...
export function initHome() {
  ...
  // ✅ FIX : initProductPreview doit attendre que le layout CSS soit
  // totalement calculé et peint avant d'installer le ResizeObserver.
  // Un double requestAnimationFrame garantit que le navigateur a terminé
  // son premier layout pass ET son premier paint avant l'observation.
  // Sans ça, le ResizeObserver se déclenche avec des dimensions provisoires
  // (souvent 0 ou incorrectes), force un second resize → repaint visible
  // qui "déplie" le panneau une micro-seconde après le chargement.
